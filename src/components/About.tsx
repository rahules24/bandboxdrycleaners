...
import field from '../assets/img/toto.png';
    ...
    return (
        <div style={{
            ...
            <Container style={{
                ...
                <Row className='my-3' style={{ width: '50%', margin:'15px' }}>
                    <h1 className="my-4" style={{color:'#000'}}>README.md</h1>
                        ...
                        <div className="accordion-item">
                            ...
                            <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body">
                                    ...
                                    href="https://rahules24.github.io/sirenscripts/" target='blank'> visit xd</a>
                                    </i>
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
                            <h2 className="accordion-header">
                                <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"
                                    style={fontStyle}>
                                    Band Box Drycleaners
                                </button>
                            </h2>
                            <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body">
                                    Your One-Stop Solution for All Your Clothing Care Needs  &lt;3
                                </div>
                            </div>
                        </div>
                        <div className="accordion-item">
